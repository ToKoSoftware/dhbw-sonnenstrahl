...
export default function startServer() {
    ...
    app.get('/api/v1/orders/:id', userIsAuthorized, (req, res) => getOrder(req, res)); //TODO
    ...
    app.put('/api/v1/orders/:id', userIsAuthorized, (req, res) => updateOrder(req, res)); //TODO
    app.put('/api/v1/orders/:id/terminate', userIsAuthorized, (req, res) => terminateOrder(req, res)); //TODO
    ...
    */
    ...
    app.get('/api/v1/users/:id', userIsAuthorized, (req, res) => getUser(req, res)); //TODO
    app.post('/api/v1/users', (req, res) => createUser(req, res));
    app.put('/api/v1/users/:id', userIsAuthorized, (req, res) => updateUser(req, res)); //TODO
    ...
    app.get('/api/v1/customers/:id', userIsAuthorized, (req, res) => getCustomer(req, res)); //TODO
    app.post('/api/v1/customers', (req, res) => createCustomer(req, res));
    app.put('/api/v1/customers/:id', userIsAuthorized, (req, res) => updateCustomer(req, res)); //TODO
